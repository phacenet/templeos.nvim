local c = require("templeos.palette")
...
theme.set_highlights = function()
	...
	hl(0, "Visual", { fg = "NONE", bg = c.yellow })
	...
	hl(0, "Search", { fg = "NONE", bg = c.yellow })
	...
	hl(0, "Type", { fg = c.qualifier, bg = "NONE" })
	...
	hl(0, "StorageClass", { fg = c.qualifier, bg = "NONE" })
	...
	hl(0, "TSMath", { fg = c.orange, bg = "NONE" })
	...
	hl(0, "NvimTreeEmptyFolderName", { fg = c.fg, bg = "NONE", italic = true })
	hl(0, "NvimTreeGitIgnored", { fg = c.fg, bg = "NONE", italic = true })
	...
	hl(0, "BookmarkAnnotationSign", { fg = c.orange, bg = "NONE" })
	...
	hl(0, "CmpItemKindSnippet", { fg = c.orange, bg = "NONE" })
